        ...
        update: function($el, val, model, options) {
            ...
            var addSelectOptions = function(optList, $el, fieldVal) {
                ...
                _.each(optList, function(obj) {
                    ...
                    if (obj === '__default__') {
                        if (typeof(selectConfig.defaultOption) === 'function') {
                            var defaultOption = selectConfig.defaultOption.call(model, val);
                            if (defaultOption) {
                                fillOption(defaultOption.label, defaultOption.value);
                            }
                        } else {
