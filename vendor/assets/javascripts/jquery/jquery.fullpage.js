		...
		function createSlimScrolling(element){
			...
			if ( contentHeight > scrollHeight) {
				...
				//creating the scrolling
					...
					// scrollbar on windows machine and older version of mac takes space to avoid glitch inclusing nicescroll
					element.find('.fp-scrollable').niceScroll({
						cursoropacitymax : 0
					});
					//commented to avoid including slimscroll
					// else{
