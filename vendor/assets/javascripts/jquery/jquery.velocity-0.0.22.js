                ...
                if (CSS.Normalizations.registered[property] && CSS.Normalizations.registered[property]("name", element) === "transform") {
                    ...
                    if (IE <= 8) {
                        try {
                            ...
                            if (typeof(console) !== 'undefined') console.log("Error setting [" + propertyName + "] to [" + propertyValue + "]");
                        }
                    } else {
                        element.style[propertyName] = propertyValue;
                    }

                    if (Velocity.debug >= 2 && typeof(console) !== 'undefined') console.log("Set " + property + " (" + propertyName + "): " + propertyValue);
                }
            }
